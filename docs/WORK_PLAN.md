...
| Phase 6 — interactive remote control | **Active — Issue #108** | 6A is merged through PR #105–#107; 6B merged in PR #111 (CI #436); 6C merged in PR #112 (CI #441); 6D policy/control plumbing is merged through PR #113–#115 (CI #453/#474/#475), with production focused encoder/media integration still pending; 6E typed bounded clipboard skeleton is active |
...
9. **Phase 6 interactive remote control — active under Issue #108.** 6A–6C are merged. 6D now has the motion-preserving adaptation policy/control loop, authorized Service→Worker profile plumbing, stale-session/retry hardening, capture-cadence application and configurable GPU H.264 target pipeline through PR #113–#115; production focused encoder/media integration remains. 6E is the current typed, text-only, bounded, permission-separated clipboard skeleton.
