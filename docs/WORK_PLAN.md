...
9. **Phase 6 interactive remote control — active under Issue #108.** 6A–6C are merged. 6D now has motion-preserving adaptation, authorized Service→Worker profile plumbing, stale-session/retry hardening, capture-cadence application and configurable GPU H.264 target plumbing through PR #113–#115, the bounded shared profile contract in #117, StreamOffer validation in #118, media-failure/control-survival hardening in #119, independent named-pipe read/write handles in #120, typed Worker capability IPC in #121, and generation-bound Service capability state in #122. PR #123 is active for asynchronous runtime capability reporting; production focused encoder/sender integration remains. 6E is merged in PR #116; 6F physical validation remains pending.
