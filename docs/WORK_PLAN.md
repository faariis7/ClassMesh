...
| Phase 5F — hardening | **Active** | PR #66 merged Hello version consistency after CI #338; PR #69 merged malformed-Protobuf frame regression after CI #343; PR #70 is active for HelloAck envelope consistency; reconnect/timeout/fuzz hardening remains |
...
8. **5F Hardening — active.** PR #66 merged Hello envelope/version consistency; PR #69 merged malformed-control-Protobuf regression coverage; PR #70 is active for HelloAck envelope consistency. Reconnect/timeout cases, fuzz targets, compatibility tests and diagnostics remain.
