...
| Phase 6 — interactive remote control | **Active — Issue #108** | 6A merged through PR #105–#107; 6B merged in PR #111 (CI #436); 6C merged in PR #112 (CI #441); 6D now includes focused adaptation/profile plumbing, bounded shared profile/offer validation, media-failure control survival, bidirectional Worker IPC handles, typed Worker capability IPC and generation-bound Service capability state through PR #113–#115 and #117–#122; PR #123 merged runtime Worker capability reporting (CI #522 green): DXGI is reported only after real capture startup and H.264 remains deferred until bounded encode validation; PR #124 merged authenticated StreamOffer preflight (CI #526 green) with explicit StreamAnswer rejection until production sender ownership exists; PR #125 merged measured H.264 benchmark evidence (CI #530 green) without advertising H264HardwareEncode; PR #126 merged bounded benchmark sample accumulation and shared benchmark→presentation target conversion (CI #537 green); PR #127 merged diagnostic bounded GPU H.264 benchmark wiring with workload-aware class caps and real keyframe evidence (CI #546 green); PR #128 merged bounded same-backend/same-target pipeline recreation evidence (CI #549 green); PR #129 merged adapter LUID + UMD driver + encoder CLSID + full-profile cache identity (CI #556 green); PR #130 is active for versioned bounded fail-closed persistence of that measured evidence before any runtime advertisement; runtime H264HardwareEncode and dynamic reconfigure remain fail-closed; production focused encoder/sender integration still remains; 6E merged in PR #116 (CI #488); 6F remains physical validation |
