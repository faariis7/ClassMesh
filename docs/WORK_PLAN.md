...
| Phase 6 — interactive remote control | **Active — Issue #108** | 6A is merged through PR #105–#107; 6B lifecycle hardening is merged in PR #111 (CI #436 green); 6C secure-desktop/input-availability diagnostics is merged in PR #112 (CI #441 green); 6D is active in PR #113 with focused profile policy plus authenticated ReceiverFeedback → profile decision → StreamReconfigure wiring, while Worker/encoder apply remains pending |
