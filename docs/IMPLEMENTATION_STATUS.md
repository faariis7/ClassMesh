...
- Phase 6 measured H.264 benchmark evidence in PR #125, bounded capability validation/runtime integration, production focused encoder/sender integration, and physical interactive-control validation under Issue #108;
...
2. Finish PR #125 measured H.264 benchmark evidence, then bind it to a bounded validation policy before runtime `H264HardwareEncode` can be advertised.
