...
- Phase 6 runtime capability reporting in PR #123, production focused encoder/sender integration, and physical interactive-control validation under Issue #108;
...
2. Finish PR #123 runtime Worker capability reporting so authenticated Hellos advertise only media primitives proven by the current Worker generation.
