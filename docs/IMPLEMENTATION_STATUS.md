...
- Phase 6 diagnostic bounded H.264 benchmark wiring in PR #127, remaining reset/reconfigure capability validation/runtime integration, production focused encoder/sender integration, and physical interactive-control validation under Issue #108;
...
2. Finish PR #127 diagnostic GPU H.264 benchmark wiring, then add real reset/recovery and reconfigure evidence before runtime `H264HardwareEncode` can be advertised.
