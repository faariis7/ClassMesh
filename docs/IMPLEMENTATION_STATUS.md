...
- Phase 6 bounded encoder recovery evidence in PR #128, remaining capability-cache/runtime integration and reconfigure validation, production focused encoder/sender integration, and physical interactive-control validation under Issue #108;
...
2. Finish PR #128 bounded encoder recovery evidence, then bind accepted measured evidence to the current adapter/driver/encoder/profile cache before runtime `H264HardwareEncode` can be advertised; dynamic reconfigure remains separately unproven.
